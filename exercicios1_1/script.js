...
const sendMarsTemperature = (temperatura, delay) => {
    setTimeout(() => { console.log(temperatura()) }, delay())
};

sendMarsTemperature(getMarsTemperature, messageDelay); // Imprime "A temperatura de Marte é: 20 graus celsius", por exemplo 4 
